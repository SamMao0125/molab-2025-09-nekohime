...
class UserModel: ObservableObject, Identifiable {
    ...
    init(id: String, dict: [String: Any]) {
        ...
        // Parse cat mood from Firebase
        let moodString = dict["catMood"] as? String ?? CatMood.available.rawValue
        let catMood = CatMood(rawValue: moodString) ?? .available
